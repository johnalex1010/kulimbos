...
<div class="header-actions" role="navigation" aria-label="<?php esc_attr_e('Acciones de compra', 'kulimbos'); ?>">
	...
	<a class="header-actions__item" href="<?php echo esc_url(home_url('/favoritos/')); ?>" aria-label="<?php esc_attr_e('Favoritos', 'kulimbos'); ?>">
		<?php kulimbos_the_icon('heart', 'header-actions__icon', 25); ?>
	...
	<a class="header-actions__item" href="<?php echo $cart_url; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- ya escapado. 
											?>" aria-label="<?php esc_attr_e('Carrito de compras', 'kulimbos'); ?>" data-cart-link>
		<?php kulimbos_the_icon('shopping-cart', 'header-actions__icon', 25); ?>
